defmodule ExMCP.ACP.Client.HandlerRunner do
  ...
  # Async work is linked so it dies with the runner; its exit signal arrives
  # here after its result or :DOWN has already been handled. The owner is the
  # process that started the runner, and GenServer handles its exit itself.
